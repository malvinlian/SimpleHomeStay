# Generated by Django 2.0.5 on 2019-03-10 03:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ManyToManyField(blank=True, default=None, to='Booking.Course')),
            ],
        ),
        migrations.CreateModel(
            name='Room',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='Booking.Course')),
                ('room', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Booking.Room')),
            ],
        ),
        migrations.CreateModel(
            name='Warden',
            fields=[
                ...
                ('hostel', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='Booking.Hostel')),
            ],
        ),
        migrations.CreateModel(
            name='User',
